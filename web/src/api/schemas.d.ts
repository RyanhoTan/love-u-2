...
export interface components {
    schemas: {
        ...
        CoupleSummary: {
            ...
            partner: null & components["schemas"]["PartnerSummary"];
        };
        /**
        ...
        CoupleSpace: {
            isBound: boolean;
            partner: null & components["schemas"]["PartnerSummary"];
            relationship: null & components["schemas"]["CoupleRelationship"];
            daysInLove: number | null;
            activeInvite: null & components["schemas"]["CoupleInvite"];
        };
        CoupleSpaceResponse: {
            message: string;
        ...
        CoupleInviteResponse: {
            message: string;
            invite: null & components["schemas"]["CoupleInvite"];
        };
        BindCoupleRequest: {
            inviteCode: string;
        };
